...
const MANIFEST_RELATIVE_PATH = 'docs/handoff/saqr-phase2-handoff-manifest.yaml';
const REQUIRED_HANDOFF_DOCS = [
    'docs/handoff/README.md',
    'docs/handoff/SAQR_Phase2_Handoff_Summary.md',
    'docs/handoff/SAQR_Phase2_Delivery_Worklist.md',
    'docs/handoff/SAQR_Phase2_Validation_Guide.md',
    'docs/handoff/saqr-phase2-handoff-manifest.yaml',
];
...
function validateManifestShape(manifest) {
    ...
    assert(manifest.phase === 'Phase 2', 'phase must equal "Phase 2"');
...
function main() {
    ...
    console.log(
        `[phase2:handoff] PASS handoff package verification (${referencedPaths.length} referenced paths, ${manifest.deliveryOwnedItems.length} delivery areas)`
    );
}
